							...
							public void fire(final Player player, final Sentence sentence, final EventRaiser raiser) {
					        	...
					        	if (weapon != null) {
					        		...
					        		if (weapon.getName().endsWith(" hand sword")) {
					        			...
					        			if (weapon.getName().equals("rod of the gm")) {
					        				comment +=  " It should be useful against strong creatures. This weapon has the highest attack in the game. Well done!";
					        			} else if (weapon.getAttackRate() < 3) {
